...
// eCH-0270: max. 1800 Bytes pro Barcode (theoretisch).
// In der Praxis: mit columns=12, eclevel=2 und XML-Content (viele Sonderzeichen
// wie ", =, /, : die Byte-Modus statt Text-Modus erzwingen) liegt die effektive
// Grenze bei ~1450 Bytes. 1400 = sicherer Puffer für alle Content-Typen.
const MAX_BYTES_PER_BARCODE = 1400;
